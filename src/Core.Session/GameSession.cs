...
public sealed class GameSession : IGameSession
{
    ...
    public event EventHandler<ClientState>? OnClientStateChanged;
    ...
    public void MoveToCharacterScreen()
    {
        // TODO: validate state transition
        State = ClientState.CharScreen;
        OnClientStateChanged?.Invoke(this, State);
    }

    public void MoveToWorldEnter()
    {
        // TODO: validate state transition
        State = ClientState.WorldEnter;
        OnClientStateChanged?.Invoke(this, State);
    }
    ...
    public void MoveToDisconnected()
    {
