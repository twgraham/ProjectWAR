...
public partial class LobbyClient : PacketHandler
{
    ...
    {
        Log.Info("CMSG_VerifyProtocolReq", "Received VerifyProtocolReq from " + context.RemoteAddress);
    ...
    {
        Log.Info("CMSG_AuthSessionTokenReq", "Received AuthSessionTokenReq from " + context.RemoteAddress);
